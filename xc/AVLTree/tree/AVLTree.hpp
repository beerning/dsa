...
class AVLTree : public BinarySearchTree<T>{
    ...
    //rotate see rotate.png
    void rotate(Node<T> *r, Node<T> *b, Node<T> *c, Node<T> *d, Node<T> *e, Node<T> *f);
    
    //zig-zag
    void zig(Node<T> *grand);    //LL
    void zag(Node<T> *grand);    //RR
    void zigzaged(Node<T> *grand, Node<T> *parent, Node<T> *child);

public:
    AVLTree() : AVLTree(NULL) {}
    AVLTree(int (*comparator)(T, T)) : BinarySearchTree<T>(comparator){}
};
...
void AVLTree<T>::rebalance(Node<T> *grand){
    ...
    if (parent->isLeft()){ //L
        if (child->isRight()) zag(parent); //LR
        zig(grand);
    }else{
        if (child->isLeft()) zig(parent);  //RL
        zag(grand);
    }
...
#pragma mark - zig-zag
template<class T>
void AVLTree<T>::zig(Node<T> *grand){//LL
...
template<class T>
void AVLTree<T>::zag(Node<T> *grand){//RR
...
template<>
class AVLTree<string> : public BinarySearchTree<string>{
    ...
    //rotate see rotate.png
    void rotate(Node<string> *r, Node<string> *b, Node<string> *c, Node<string> *d, Node<string> *e, Node<string> *f);
    
    //zig-zag
    void zig(Node<string> *grand);    //LL
    void zag(Node<string> *grand);    //RR
    void zigzaged(Node<string> *grand, Node<string> *parent, Node<string> *child);

public:
    AVLTree() : AVLTree(NULL) {}
    AVLTree(int (*comparator)(string, string)) : BinarySearchTree<string>(comparator){}
};
...
#pragma mark - zig-zag
void AVLTree<string>::zig(Node<string> *grand){//LL
    Node<string> *parent = grand->_left;
    Node<string> *child = parent->_right;
...
void AVLTree<string>::zag(Node<string> *grand){//RR
    Node<string> *parent = grand->_right;
    Node<string> *child = parent->_left;
...
template<>
class AVLTree<const char *> : public BinarySearchTree<const char *>{
    ...
    //rotate see rotate.png
    void rotate(Node<const char *> *r, Node<const char *> *b, Node<const char *> *c, Node<const char *> *d, Node<const char *> *e, Node<const char *> *f);
    
    //zig-zag
    void zig(Node<const char *> *grand);    //LL
    void zag(Node<const char *> *grand);    //RR
    void zigzaged(Node<const char *> *grand, Node<const char *> *parent, Node<const char *> *child);

public:
    AVLTree() : AVLTree(NULL) {}
    AVLTree(int (*comparator)(const char *, const char *)) : BinarySearchTree<const char *>(comparator){}
};
...
#pragma mark - zig-zag
void AVLTree<const char *>::zig(Node<const char *> *grand){//LL
    Node<const char *> *parent = grand->_left;
    Node<const char *> *child = parent->_right;
...
void AVLTree<const char *>::zag(Node<const char *> *grand){//RR
    Node<const char *> *parent = grand->_right;
    Node<const char *> *child = parent->_left;
